...
import 'package:test/ui/widgets/bottomsheetTopTitleAndCloseButton.dart';
...
import '../../../widgets/bottomsheetTopTitileAndCloseWithoutLogin.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: Color.fromRGBO(85, 140, 225, 1),
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            // ),
            BottomsheetTopTitleAndCloseButtonWithoutLogin(
              onTapCloseButton: () {
                if (context.read<RequestResetPasswordCubit>().state
                    is RequestResetPasswordInProgress) {
                  return;
