...
import 'package:test/cubits/attendanceCubit.dart';
import 'package:test/cubits/authCubit.dart';
import 'package:test/cubits/holidaysCubit.dart';
import 'package:test/cubits/resultsCubit.dart';
...
import 'package:test/cubits/studentGuardianDetailsCubit.dart';
import 'package:test/cubits/timeTableCubit.dart';
import 'package:test/data/models/notificationDetails.dart';
import 'package:test/data/repositories/notificationRepository.dart';
...
import 'package:test/ui/screens/home/cubits/assignmentsTabSelectionCubit.dart';
import 'package:test/ui/screens/home/widgets/bottomNavigationItemContainer.dart';
import 'package:test/ui/screens/home/widgets/examContainer.dart';
import 'package:test/ui/screens/home/widgets/homeContainer.dart';
...
import 'package:test/ui/screens/home/widgets/moreMenuBottomsheetContainer.dart';
import 'package:test/ui/screens/home/widgets/parentProfileContainer.dart';
import 'package:test/ui/screens/reports/reportSubjectsContainer.dart';
import 'package:test/ui/widgets/appUnderMaintenanceContainer.dart';
import 'package:test/ui/widgets/assignmentsContainer.dart';
import 'package:test/ui/widgets/attendanceContainer.dart';
import 'package:test/ui/widgets/customRoundedButton.dart';
import 'package:test/ui/widgets/errorContainer.dart';
import 'package:test/ui/widgets/forceUpdateDialogContainer.dart';
import 'package:test/ui/widgets/holidaysContainer.dart';
import 'package:test/ui/widgets/noticeBoardContainer.dart';
import 'package:test/ui/widgets/schoolGalleryWithSessionYearFilterContainer.dart';
import 'package:test/ui/widgets/settingsContainer.dart';
import 'package:test/ui/widgets/timetableContainer.dart';
import 'package:test/utils/constants.dart';
import 'package:test/utils/homeBottomsheetMenu.dart';
...
import '../studentGpt/studentGpt.dart';
...
class HomeScreenState extends State<HomeScreen>
  ...
  late List<BottomNavItemTwo> _bottomNavItems = [];
  ...
  void updateBottomNavItems() {
    _bottomNavItems = context
        ...
        ? [
            BottomNavItemTwo(
              title: homeKey,
              activeIconUrl: IconlyBold.home,
              disableIconUrl: IconlyLight.home,
              activeImageUrl: '',
              disableImageUrl: '',
            ),
            BottomNavItemTwo(
              title: assignmentsKey,
              // activeIconUrl: IconlyBold.activity,
              // disableIconUrl: IconlyLight.activity,
              activeImageUrl:
                  'assets/images/bottom_nav/bottom_nav_1_active.svg',
              disableImageUrl:
                  'assets/images/bottom_nav/bottom_nav_1_inactive.svg',
            ),
            BottomNavItemTwo(
              title: gptKey,
              // activeIconUrl: IconlyBold.swap,
              // disableIconUrl: IconlyLight.swap,
              activeImageUrl:
                  'assets/images/bottom_nav/bottom_nav_2_active.svg',
              disableImageUrl:
                  'assets/images/bottom_nav/bottom_nav_2_inactive.svg',
            ),
            BottomNavItemTwo(
              title: menuKey,
              activeIconUrl: IconlyBold.category,
              disableIconUrl: IconlyLight.category,
              activeImageUrl: '',
              disableImageUrl: '',
            ),
            BottomNavItemTwo(
              title: settingsKey,
              activeIconUrl: IconlyBold.setting,
              disableIconUrl: IconlyLight.setting,
              activeImageUrl: '',
              disableImageUrl: '',
            ),
            // BottomNavItem(
            ...
            // ),
            // BottomNavItem(
            //   activeImageUrl: Utils.getImagePath("setting_icon.svg"),
            //   disableImageUrl: Utils.getImagePath("setting_icon.svg"),
            //   title: settingsKey,
            // ),
          ]
        : [
  ...
  Future<void> changeBottomNavItem(int index) async {
    ...
    if (_bottomNavItems[index].title == menuKey) {
