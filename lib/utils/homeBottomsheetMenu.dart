...
final List<Menu> homeBottomSheetMenu = [
  ...
  Menu(
      menuModuleId: attendanceManagementModuleId.toString(),
      iconUrl: Utils.getImagePath("quiz.svg"),
      title: quiz),
  Menu(
    menuModuleId: timetableManagementModuleId.toString(),
    iconUrl: Utils.getImagePath("student_counsling.svg"),
    title: studentCounselling,
  ),
  Menu(
    menuModuleId: announcementManagementModuleId.toString(),
    iconUrl: Utils.getImagePath("student_gpt.svg"),
    title: gptKey,
  ),
  Menu(
  ...
  Menu(
      iconUrl: Utils.getImagePath("bus.svg"),
      title: busKey,
      menuModuleId: galleryManagementModuleId.toString()),
  // Menu(
